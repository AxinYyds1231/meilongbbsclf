// functions/api/adminDeletePostWithReason.js
...
export async function onRequest(context) {
    ...
    try {
        ...
        const success = await db.deletePostById(postId, reason, adminData.uid || 'admin');
        if (!success) {
        ...
        // 通知作者
        await db.addNotification(post.authorUid, 'post_deleted', `您的帖子《${post.title}》已被管理员删除，原因：${reason}`, `/index.html`);
